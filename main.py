...
async def timeout(ctx, member: discord.Member, time: int, *, reason=None):
    ...
    if not role:
        ...
        client.run('MTA3ODgxMjQ5OTE2MTM5OTM5Ng.GFhPt5.ncc-v5SMNs_Rujq8xrASGbeodzi3XRmIaXfaOc')


bot.run('MTA3ODgxMjQ5OTE2MTM5OTM5Ng.GFhPt5.ncc-v5SMNs_Rujq8xrASGbeodzi3XRmIaXfaOc')